...
const faculty = [
  {
    ...
    bio: 'Dr. Shwetha Marigoudar serves as the Dean of the Faculty of Computing and IT. With extensive academic experience, she leads the department toward excellence in research and industry collaboration.',
  ...
  },
  {
    ...
    bio: 'Prof. Rajashekar G C leads the School of Computer Applications with a focus on innovation in computer application education and skill development.',
  ...
  },
  {
    ...
    bio: 'Ms. Shamina Attar leads the School of Computer Science, focusing on transformative impact through innovation in computer science education and research.',
    education: ['MCA'],
  },
  {
    name: 'Usha N',
    designation: 'HOD & Assistant Professor (SCA)',
    initials: 'UN',
  ...
  {
    name: 'Manjula K.',
    designation: 'HOD & Assistant Professor (SCS)',
    initials: 'MK',
    photoUrl: 'https://gmu.ac.in/FCIT/images/HODCS.jpg',
    gradient: 'from-orange-600 to-red-600',
    specialization: 'Cyber Security, Computer Science',
    education: ['MSc in CS', 'PG Dip in Cyber Security'],
  },
  {
    name: 'Shivakumara C R',
    designation: 'Assistant Professor (SCA)',
    initials: 'SC',
    photoUrl: 'https://gmu.ac.in/FCIT/images/Shivakumara.jpg',
  ...
  {
    name: 'Varun K S',
    designation: 'Assistant Professor (SCS)',
    initials: 'VK',
    photoUrl: 'https://gmu.ac.in/FCIT/images/VARUN.jpg',
    gradient: 'from-fcit-300 to-violet-600',
    specialization: 'Cyber Security, Computer Science',
    education: ['MSc in CS', 'PG Diploma in Cyber Security'],
  },
  {
    name: 'Ayesha Khannum',
    designation: 'Assistant Professor (SCS)',
  ...
  },
  {
    ...
    specialization: 'Languages/Computer Science',
    education: ['MA', 'Diploma in CS', 'KSET'],
  },
]
